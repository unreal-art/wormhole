...
import {
  getWalletClient,
  getTokenBalance as getEtherlinkBalance,
  approveToken,
  lockTokens as lockEtherlinkTokens,
} from "@/utils/etherlinkContract"
...
export default function SwapPage() {
  ...
  const [sourceChain, setSourceChain] = useState<"etherlink" | "near">(
    "etherlink"
  )
      ...
      if (
        ...
        try {
          ...
          const amountWei = BigInt(
            Math.floor(parseFloat(value) * Math.pow(10, 18))
          ).toString()
  ...
  const handleSwap = async () => {
    if (
      (!signedAccountId && sourceChain === "near") ||
    ...
    try {
      ...
      if (sourceChain === "etherlink" && targetChain === "near") {
        ...
        const nonce = await publicClient.readContract({
          ...
          functionName: "nonces", // ✅ Correct plural form
          args: [evmAddress],
        })
            ...
            <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
              ...
              <div className="flex items-center space-x-2">
                <div className="h-8 w-8 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-600 flex items-center justify-center">
                  <Image
                    src={
                      sourceChain === "near" ? "/near-logo.svg" : UnrealLogoPath
                    }
            ...
            <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
              ...
              <div className="flex items-center space-x-2">
                <div className="h-8 w-8 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-600 flex items-center justify-center">
                  <Image
                    src={
                      targetChain === "near" ? "/near-logo.svg" : UnrealLogoPath
                    }
          ...
          <div className="p-4 mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900 rounded-xl">
            ...
            <div className="flex justify-between mb-1">
              ...
              <div>
                {quoteLoading ? (
                  ...
                  <span>
                    {swapQuote} UNREAL{" "}
                    <span className="text-xs text-green-500">(via 1inch)</span>
                  </span>
                ) : (
            ...
            <div className="flex justify-between">
              ...
              <span className="flex flex-col text-right">
                ...
                <span className="text-xs">
                  {signedAccountId || "No NEAR wallet"}
                </span>
              </span>
            </div>
          </div>
